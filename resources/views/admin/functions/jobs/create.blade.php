...
<div class="pb-col-left">
    ...
    <div class="pb-card mb-3 pb-fade-up pb-delay-2">
        <div class="pb-card-header">
            <div>
        ...
        <div class="pb-form-grid p-4">
            ...
            <div class="pb-form-group text-sm mb-4">
                <label class="pb-label block mb-2 text-sm" for="client_name">Client / Company Name <span class="pb-required">*</span></label>
                <input class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2 @error('client_name') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="client_phone">Phone Number <span class="pb-required">*</span></label>
                <input class="pb-input rounded-lg block bg-gray-950 sm:w-full md:w-1/2  @error('client_phone') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="client_email">Email Address</label>
                <input class="pb-input rounded-lg block bg-gray-950 sm:w-full md:w-1/2  @error('client_email') pb-input-error @enderror"
            ...
            <div class="pb-form-group pb-col-span-2">
                <label class="pb-label text-sm mb-4" for="client_address">Client Address</label>
                <textarea class="pb-input pb-textarea rounded-lg block bg-gray-950 sm:w-full md:w-1/2  @error('client_address') pb-input-error @enderror"
    ...
    <div class="pb-card mb-3 pb-fade-up pb-delay-3">
        <div class="pb-card-header">
            <div>
                <div class="pb-card-title">
        ...
        <div class="pb-form-grid p-4">
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="job_type">Job Type <span class="pb-required">*</span></label>
                <select class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2  pb-select @error('job_type') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="size_format">Size / Format <span class="pb-required">*</span></label>
                <input class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2  @error('size_format') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="quantity">Quantity <span class="pb-required">*</span></label>
                <input class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2  @error('quantity') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="material">Material / Substrate</label>
                <select class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2  @error('material') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="finish">Finish</label>
                <select class="rounded-lg block bg-gray-950 sm:w-auto md:w-1/2  @error('finish') pb-input-error @enderror"
            ...
            <div class="pb-form-group pb-col-span-2">
                <label class="pb-label text-sm mb-4" for="special_instructions">Special Instructions / Notes</label>
                <textarea class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2 "
    ...
    <div class="pb-card  mb-3 pb-fade-up pb-delay-4">
        <div class="pb-card-header">
            <div>
                <div class="pb-card-title">
        ...
        <div class="pb-form-grid p-4">
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="brief_date">Brief Date <span class="pb-required">*</span></label>
                <input class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2  @error('brief_date') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="expected_delivery_date">Expected Delivery Date</label>
                <input class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2  @error('expected_delivery_date') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="priority">Priority Level <span class="pb-required">*</span></label>
                <select class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2 @error('priority') pb-input-error @enderror"
            ...
            <div class="pb-form-group">
                <label class="pb-label text-sm mb-4" for="brief_received_by">Brief Received By</label>
                <input class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2 " id="brief_received_by" name="brief_received_by" type="text"
    ...
    <div class="pb-card mb-3 pb-fade-up pb-delay-4">
        ...
        <div class="pb-form-grid p-4">
            <div class="pb-form-group pb-col-span-2">
                <label class="pb-label text-sm mb-4" for="design_file">Artwork File</label>
                <input class="rounded-lg block bg-gray-950 sm:w-full md:w-1/2 "
    ...
    <div class="pb-card pb-fade-up pb-delay-4">
        ...
        <div class="flex items-center gap-3 px-6 pb-6">
            <button type="submit" class="pb-btn pb-btn-success p-3">
